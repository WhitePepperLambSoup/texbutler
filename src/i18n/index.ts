...
const zh: Dict = {
  ...
  "ai.generatePlaceholder": "让 AI 生成 LaTeX 代码，如：生成一个三线表、生成一段带公式的证明…",
  "ai.generate": "生成 LaTeX",
...
const en: Dict = {
  ...
  "ai.generatePlaceholder": "Ask AI to generate LaTeX, e.g. a three-line table, a proof with formulas…",
  "ai.generate": "Generate LaTeX",
  "ai.insertEditor": "Insert to editor",
  "ai.saveFile": "Save as file",
